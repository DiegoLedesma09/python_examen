...
def parse_arguments():
    ...
    parser.add_argument('input_csv', help='Ruta al archivo CSV/TSV con los identificadores de genes y datos de expresión.')
    parser.add_argument('input_gff', help='Ruta al archivo GFF')
    parser.add_argument('output_dir', help='Ruta al directorio de salida')
